...
export const metadata: Metadata = {
  title: "Dashboard",
  description:
    "A single-window view of India's public money — MPLADS spending, your representatives, where the national tax rupee comes from and goes, plus a tax estimator.",
};
    ...
    <div className="space-y-8">
      <section>
        ...
        <p className="mt-1 text-sm text-slate-600">
          One window over India&apos;s public money — spending, your representatives, and where the
          national tax rupee comes from and goes.
        </p>
      </section>
